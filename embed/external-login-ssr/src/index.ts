	...
	const html = renderLayout(
		...
		<div class="page">
			...
			<div class="deploy-section">
				...
				<a href="https://deploy.workers.cloudflare.com/?url=https://github.com/Divinci-AI/Examples/tree/main/embed/external-login-ssr" class="deploy-button" target="_blank">
